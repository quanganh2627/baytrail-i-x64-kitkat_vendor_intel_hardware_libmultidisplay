...
IMPLEMENT_CLIENT_API_0(getVideoState,                MDS_VIDEO_STATE, MDS_VIDEO_STATE_UNKNOWN)
...
IMPLEMENT_CLIENT_API_1(setVideoState,                MDS_VIDEO_STATE,           status_t, NO_INIT)
IMPLEMENT_CLIENT_API_1(setVideoSourceInfo,           MDSVideoSourceInfo*,       status_t, NO_INIT)
IMPLEMENT_CLIENT_API_1(getVideoSourceInfo,           MDSVideoSourceInfo*,       status_t, NO_INIT)
